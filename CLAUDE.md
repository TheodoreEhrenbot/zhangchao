...
**YOU ARE IN: `zhangchao/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/zhangchao/` (rig root) or other directories
...
**Your mail address:** `zhangchao/polecats/furiosa`
**Your rig:** zhangchao
**Your Witness:** `zhangchao/witness`
...
| Ask Witness for help | `gt mail send zhangchao/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`zhangchao/witness`) when:
...
```bash
gt mail send zhangchao/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
